...
import { PartModel, CustomerModel, UserModel, VehicleModel, JobManagerModel, TaskModel, PartsUsedModel, JobModel, PaymentModel, MyContext } from './types';
...
export type ResolversTypes = {
  ...
  PartUsed: ResolverTypeWrapper<Omit<PartUsed, 'part'> & { part: ResolversTypes['Part'] }>;
...
export type ResolversParentTypes = {
  ...
  Task: TaskModel;
  PartUsedInput: PartUsedInput;
  PartUsed: Omit<PartUsed, 'part'> & { part: ResolversParentTypes['Part'] };
  Token: Token;
  User: UserModel;
  CreateUser: CreateUser;
  CreateVehicle: CreateVehicle;
